...
%%%----------------------------------------------------------------------------
%%% @doc Discrete T-maze actuator for benchmarking purposes.
%%% @end
%%%----------------------------------------------------------------------------
-module(dtm_actuator).
...
%%      T-maze simulator, and waits for the resulting Fitness and
...
actuate(dtm, {AgentId, Output, Params, _VL, ScapePid, _ActuatorId, ModState}) ->
  private_scape:actuate(ScapePid, AgentId, self(), move, {Params, Output}),
  ModState.