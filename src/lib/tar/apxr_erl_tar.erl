...
%% with modifications:
%% - Change module name to `apxr_erl_tar`
...
%% - Allow setting file_info opts on :apxr_erl_tar.add
...
make_safe_path(Path, #read_opts{cwd=Cwd}) ->
	case apxr_filename:safe_relative_path(Path) of
		unsafe ->
